...
最新版使用record_with2situation.py 采集，使用convert_usingRelativeCartesian_pos.py、convert_using_all_is_RelativeCartesian_pos.py 转换，使用verify_converted_data.py 肉眼检验
